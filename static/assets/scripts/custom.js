...
function init_template(){
  ...
  if(inputField.length){
    ...
    var nameValidator = /^[a-zA-ZÃ Ã¡Ã¢Ã¤Ã£Ã¥ÄÄÄÄÃ¨Ã©ÃªÃ«ÄÄ¯Ã¬Ã­Ã®Ã¯ÅÅÃ²Ã³Ã´Ã¶ÃµÃ¸Ã¹ÃºÃ»Ã¼Å³Å«Ã¿Ã½Å¼ÅºÃ±Ã§ÄÅ¡Å¾ÃÃÃÃÃÃÄÄÄÄÄÃÃÃÃÃÃÃÃÄ®ÅÅÃÃÃÃÃÃÃÃÃÃÅ²ÅªÅ¸ÃÅ»Å¹ÃÃÃÅÃÄÅ Å½âÃ° ,.'-]+$/u;
  ...
  if(locationBut.length){
    ...
    if (typeof(getLocation) != 'undefined' && getLocation != null){
      getLocation.addEventListener('click',function(){ geoLocate();})
    }
  }
